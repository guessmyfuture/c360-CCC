...
class BuildingGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Building entity")
        ...
        .repeat(2) {
            ...
            .post("/api/buildings")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "buildingName":"SAMPLE_TEXT", "buildingCoverImage":null, "buildingImage1":null, "buildingImage2":null, "buildingImage3":null, "buildingEstablishedYear":"0", "location":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
